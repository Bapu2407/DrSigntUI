...
/* harmony import */ var ngx_loading__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-loading */ "./node_modules/ngx-loading/__ivy_ngcc__/ngx-loading/ngx-loading.js");
...
class LoginComponent {
    constructor(router, ngZone, toastr) {
        this.router = router;
        this.ngZone = ngZone;
        this.toastr = toastr;
        //this.email = "admin"
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], viewQuery: function LoginComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 17, vars: 4, consts: [[1, "login-page"], [1, "row", "justify-content-md-center"], [1, "col-md-4"], ["src", "assets/images/logo_signet.png", "width", "300px"], ["role", "form"], [1, "form-content"], [1, "form-group"], ["type", "text", "name", "email", "id", "email", "placeholder", "Email", 1, "form-control", "input-underline", "input-lg", 3, "ngModel", "ngModelChange"], ["type", "password", "name", "password", "id", "password", "placeholder", "Password", 1, "form-control", "input-underline", "input-lg", 3, "ngModel", "ngModelChange"], [1, "btn", "rounded-btn", 3, "click"], [1, "my-container"], [3, "show"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"] }, { type: ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__["ToastrManager"] }]; }, { emailRef: [{
