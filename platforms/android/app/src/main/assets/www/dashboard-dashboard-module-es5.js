...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
  ...
  function srcAppLayoutDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ngx-loading */
    "./node_modules/ngx-loading/__ivy_ngcc__/ngx-loading/ngx-loading.js"); //import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
    ...
    function DashboardComponent_tr_37_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var appointment_r2 = ctx.$implicit;
      ...
      _createClass(DashboardComponent, [{
        ...
        value: function getDaysOfMonth() {
          ...
          for (var i = 30; i > 0; i--) {
            ...
            console.log('nextDay.toISOString() .substr(0,10) == ', nextDay.toISOString().substr(0, 10)); //this.monthDayslabel.push(nextDay.toISOString().substr(0,10));
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      directives: [ng2_charts__WEBPACK_IMPORTED_MODULE_7__["BaseChartDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgIf"], ngx_loading__WEBPACK_IMPORTED_MODULE_9__["ɵb"]],
