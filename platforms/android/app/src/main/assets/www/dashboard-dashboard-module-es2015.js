...
/* harmony import */ var src_app_services_data_access__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/data-access */ "./src/app/services/data-access.ts");
...
function DashboardComponent_tr_37_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](7, "Area :");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](appointment_r2 == null ? null : appointment_r2.location == null ? null : appointment_r2.location.city);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](appointment_r2 == null ? null : appointment_r2.location == null ? null : appointment_r2.location.area);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](appointment_r2 == null ? null : appointment_r2.location == null ? null : appointment_r2.location.address);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](appointment_r2 == null ? null : appointment_r2.patient == null ? null : appointment_r2.patient.name);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](appointment_r2 == null ? null : appointment_r2.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](ctx_r0.convertToHumanDate(appointment_r2.appointmentDate));
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](appointment_r2 == null ? null : appointment_r2.appointmentTime);
} }
function DashboardComponent_tbody_38_Template(rf, ctx) { if (rf & 1) {
...
class DashboardComponent {
    constructor(router, toastr, dataService) {
        this.router = router;
        this.toastr = toastr;
        ...
        this.ArrangedTotalDistanceCoveredByDate = [];
        // invoice Chart
    ...
    fetchAllData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.fetchDaysApointment();
            yield this.fetchMonthInvoices();
            yield this.fetchAllmonthsAppointment();
            this.loading = false;
        });
    }
    fetchMonthInvoices() {
        try {
            let firstDayOfMonth = moment__WEBPACK_IMPORTED_MODULE_3__(this.firstDayOfMonth).format('DD-MM-YYYY');
            let lastDayOfMonth = moment__WEBPACK_IMPORTED_MODULE_3__(this.lastDayOfMonth).format('DD-MM-YYYY');
    ...
    getDaysOfMonth() {
        let thisday = new Date(this.beginningDayOfMonth);
    ...
    getDaysInMonth(month, year) {
        let thisday = new Date(this.dateBeforeWeek);
        this.allDates = [];
        this.labelDays = [];
        for (let i = 7; i > 0; i--) {
...
DashboardComponent.ɵfac = function DashboardComponent_Factory(t) { return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_5__["ToastrManager"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_services_data_access__WEBPACK_IMPORTED_MODULE_6__["DataAccess"])); };
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], decls: 42, vars: 16, consts: [[1, "row"], [1, "col", "col-xl-6", "col-lg-6"], ["baseChart", "", 3, "datasets", "labels", "colors", "options", "legend", "chartType"], ["baseChart", "", 3, "datasets", "labels", "options", "legend", "colors", "chartType"], [1, "col-md-12"], [1, "card", "mb-3"], [1, "card-header", "custom_text"], [1, "card-body"], [1, "col", "col-md-12"], [1, "table-responsive"], [1, "table"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [1, "my-container"], [3, "show"], ["colspan", "7", "align", "center"]], template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](37, DashboardComponent_tr_37_Template, 22, 7, "tr", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DashboardComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_5__["ToastrManager"] }, { type: src_app_services_data_access__WEBPACK_IMPORTED_MODULE_6__["DataAccess"] }]; }, null); })();
...
/* harmony import */ var ngx_loading__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ngx-loading */ "./node_modules/ngx-loading/__ivy_ngcc__/ngx-loading/ngx-loading.js");
...
DashboardModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function DashboardModule_Factory(t) { return new (t || DashboardModule)(); }, imports: [[
            ...
            _shared__WEBPACK_IMPORTED_MODULE_5__["RptModule"],
